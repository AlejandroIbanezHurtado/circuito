 ...
 */
final class Version20220209213158 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reserva CHANGE fecha fecha DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE fecha_fin fecha_fin DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reserva CHANGE fecha fecha DATETIME NOT NULL, CHANGE fecha_fin fecha_fin DATETIME DEFAULT NULL');

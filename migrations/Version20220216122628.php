 ...
 */
final class Version20220216122628 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coche ADD potencia INT DEFAULT NULL, ADD cilindrada INT DEFAULT NULL, ADD velocidad INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coche DROP potencia, DROP cilindrada, DROP velocidad');
        ...
        $this->addSql('ALTER TABLE modelo CHANGE nombre nombre VARCHAR(30) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE imagen imagen VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');

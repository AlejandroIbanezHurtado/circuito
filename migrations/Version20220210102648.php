 ...
 */
final class Version20220210102648 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coche ADD imagen VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');

 ...
 */
final class Version20220209225340 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE detalle_reserva CHANGE reserva_id reserva_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE detalle_reserva CHANGE reserva_id reserva_id INT NOT NULL');

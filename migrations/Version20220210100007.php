 ...
 */
final class Version20220210100007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coche ADD imagen VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE reserva CHANGE fecha fecha DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coche DROP imagen');
